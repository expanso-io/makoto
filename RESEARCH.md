...
> SLSA proves software wasn't tampered with. Data Provenance Levels proves data wasn't tampered with AND explains what happened to it. The output—a DBOM—is to datasets what an SBOM is to software packages.
...
| **Makoto** | The project and brand name for this data provenance specification and ecosystem |
| **Makoto** | Data Provenance Levels - the specification defining incremental security levels (L1/L2/L3) for data supply chain assurance |
